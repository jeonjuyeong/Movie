...
<link href="/ctrl/resources/css/smart_editor2.css" rel="stylesheet" type="text/css">
<style type="text/css">
	body { margin: 10px; }
</style>
<script type="text/javascript" src="/ctrl/resources/js/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="/ctrl/resources/js/jindo_component.js" charset="utf-8"></script>
<script type="text/javascript" src="/ctrl/resources/js/SE2B_Configuration_Service.js" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="/ctrl/resources/js/SE2B_Configuration_General.js" charset="utf-8"></script>	<!-- 설정 파일 -->

<script type="text/javascript" src="/ctrl/resources/js/SE2BasicCreator.js" charset="utf-8"></script>

<script src='/ctrl/resources/js/smarteditor2.min.js' charset='utf-8'></script>
<script type="text/javascript" src='/ctrl/resources/js/hp_SE2M_AttachQuickPhoto.js' charset='utf-8'></script>
<script type="text/javascript">

</script>
<!-- Smart Editor -->
<script type="text/javascript" src="<%=request.getContextPath()%>/ctrl/resources/js/HuskyEZCreator.js" charset="utf-8"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/ctrl/resources/js/hp_SE2M_AttachQuickPhoto.js" charset="utf-8"></script>
...
function pasteHTML(filepath){
    var sHTML = '<img src="<%=request.getContextPath()%>/ctrl/resources/upload/'+filepath+'">';
